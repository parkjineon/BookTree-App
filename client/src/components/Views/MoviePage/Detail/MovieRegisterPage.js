      ...
      <div className='detailBody'>
        ...
        <div className='detailInfo'>
          ...
          <Descriptions column={2} labelStyle={{
            ...
            <Descriptions.Item label="관람 날짜" span={1}><DatePicker locale={ko} dateFormat="yyyy-MM-dd" selected= {date} onChange={(date) => setDate(date)} /></Descriptions.Item>
...
export default auth(MovieRegisterPage,true)